...
// vocabulary), how much any one sentence gives away (the depth), and how many
// animals per deal the player can find straight from their own card (the
// footholds). Players said the difficulty jumped when several of those moved
...
//     at least four squares; then counting words; then the big board; and last
//     a level whose final deals have no starting point at all;
...
export const FUNNEL = [
  ...
  { N: 9, lands: 12, tier: 2, vocab: 3, perCard: 2, spare: 0, landmarks: 1, depth: 4, footholds: [1, 1, 0, 0], pairs: 1 },
